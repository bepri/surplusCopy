function getOutput() {
  let name = document
    .getElementById(
      "TitleBox--_Asset_Display_html--asset-basics----QmFzaWNz---0"
    )
    .getElementsByClassName("asset-name");
  let description = document
    .getElementById(
      "TitleBox--_Asset_Display_html--asset-basics----QmFzaWNz---0"
    )
    .getElementsByClassName("asset-description");
  let serial = document
    .getElementById("CF-19-ShowRow")
    .getElementsByClassName("value");
  let tag = document
    .getElementById("CF-23-ShowRow")
    .getElementsByClassName("value");

  let fullStr =
    name[0].innerText.substring(6) +
    "\n" +
...
surplusBtn.innerHTML +=
  "<button id='surplusBtn'>Copy surplus information</button>";
